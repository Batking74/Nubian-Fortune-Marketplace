...
async function handleActivate() {
    try {
        ...
        await Promise.all(cacheNames.map(cacheName => cacheName !== staticCacheName && cacheName !== dynamicCacheName ? caches.delete(cacheName) : null));
...
async function handleFetch(event) {
    try {
        ...
        const cacheStore = await caches.open(dynamicCacheName);
